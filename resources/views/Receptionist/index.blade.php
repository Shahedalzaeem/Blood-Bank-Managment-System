            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $donor->record_date }}</td>
                        <td>
                            <a href="{{ route('donors.show', $donor->id) }}" class="info-btn">Information</a>
                            <a href="{{ route('donors.edit', $donor->id) }}" class="info-btn" style="background: #28a745;">Modify</a>
