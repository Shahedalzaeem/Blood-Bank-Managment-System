                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $unit->rhesus_factor }}</td>
                            <td>{{ $unit->quantity }}</td>
                            <td>
                                <form action="/bank-employee/blood-inventory/{{ $unit->id }}" method="POST" style="display:inline">
                                    @csrf
                                    @method('DELETE')
                                    <button class="delete-btn">Delete</button>
                                </form>
                                <form action="/bank-employee/blood-inventory/{{ $unit->id }}/process" method="POST" style="display:inline">
                                    @csrf
                                    <button class="info-btn" style="background: #28a745;">Process</button>
                                </form>
                            </td>
                        </tr>
                        @endforeach
