...
<head>
    ...
    <title>Bad Blood Inventory</title>
        ...
        <main class="table">
            ...
            <section class="table__body">
                <table>
                    ...
                    <tbody>
                        @foreach($records as $badBlood)
                        <tr>
                            <td>{{ $badBlood->id }}</td>
                            <td>{{ $badBlood->component_type }}</td>
                            <td>{{ $badBlood->blood_type }}</td>
                            <td>{{ $badBlood->rhesus_factor }}</td>
                            <td>{{ $badBlood->quantity }}</td>
                            <td>
                                <form action="{{ route('bank-employee.bad-blood.destroy', $badBlood->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
                                    <button class="delete-btn" type="submit" onclick="return confirm('Are you sure to delete this bad blood?')">Delete</button>
                                </form>
                            </td>
                        </tr>
                        @endforeach
