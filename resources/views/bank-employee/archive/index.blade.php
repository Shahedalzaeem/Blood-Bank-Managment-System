    ...
    <main class="table">
        ...
        <section class="table__body">
            <table>
                ...
                <tbody>
                    @foreach($records as $archivedBlood)
                    <tr>
                        <td>{{ $archivedBlood->id }}</td>
                        <td>{{ $archivedBlood->blood_type }}</td>
                        <td>{{ $archivedBlood->rhesus_factor }}</td>
                        <td>{{ $archivedBlood->quantity }}</td>
                        <td>
                            <form action="{{ route('bank-employee.archive.destroy', $archivedBlood->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="delete-btn" onclick="return confirm('Are you sure to permanently delete this archived record?')">Delete</button>
                            </form>
                        </td>
                    </tr>
                    @endforeach
