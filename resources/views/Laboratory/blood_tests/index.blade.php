                    ...
                    <tbody>
                        @foreach ($tests as $test)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('blood-tests.edit', $test->id) }}" class="info-btn" style="background: #28a745;">Edit</a>
                                    <form action="{{ route('blood-tests.destroy', $test->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
